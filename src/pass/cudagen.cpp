...
// Value* CUDAGen::llcall(const string name, llvm::Type* ret_type,
...
// llvm::Type* CUDAGen::lltype(const DataType& type)
// {
//     switch (type.btype) {
//         case BaseType::BOOL:
...
// Value* CUDAGen::visit(Const& cnst)
// {
...
// Value* CUDAGen::visit(Get& e)
// {
//     auto val = eval(e.val);
//     return builder()->CreateExtractValue(val, e.col);
// }

// Value* CUDAGen::visit(New& e)
// {
...
// Value* CUDAGen::visit(NaryExpr& e)
// {
//     switch (e.op) {
//         case MathOp::ADD: {
//             if (e.type.is_float()) {
...
// Value* CUDAGen::visit(Select& select)
// {
...
// void CUDAGen::visit(IfElse& ifelse)
// {
...
// void CUDAGen::visit(NoOp&) { /* do nothing */ }

// Value* CUDAGen::visit(IsValid& is_valid)
// {
...
// Value* CUDAGen::visit(SetValid& set_valid)
// {
...
// Value* CUDAGen::visit(FetchDataPtr& fetch_data_ptr)
// {
...
// llvm::Value* CUDAGen::visit(Sym old_sym)
// {
...
// {
//     CUDAGenCtx ctx(kernel);
//     CUDAGen llgen(ctx, llmod);
//     kernel->Accept(llgen);
// }
